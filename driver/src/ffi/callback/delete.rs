...
pub unsafe extern "C" fn mongo_delete_one(
    ...
    let (coll, filter_doc, options) = with_err_callback!(callback, userdata, || {
        ...
        crate::ffi::ops::delete::prepare_delete(
            &(*client).client,
            ctx,
            db_name,
            coll_name,
    ...
    client_ref.runtime.spawn(async move {
        let result =
            crate::ffi::ops::delete::execute_delete_one(coll, filter_doc, options, session_ref).await;
...
pub unsafe extern "C" fn mongo_delete_many(
    ...
    client_ref.runtime.spawn(async move {
        let result =
            crate::ffi::ops::delete::execute_delete_many(coll, filter_doc, options, session_ref).await;
