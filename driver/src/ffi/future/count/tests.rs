...
use crate::ffi::{
    ...
    future::{
        ...
        count::{mongoc_future_count_documents, mongoc_future_estimated_document_count},
        future::{mongoc_future_destroy, mongoc_future_get_count, mongoc_future_is_finished},
    },
...
fn test_count_documents_null_db_name() {
    ...
    unsafe {
        ...
        let future = mongoc_future_count_documents(
            client,
            ptr::null(),
        ...
        let ok = mongoc_future_get_count(future, &mut count, &mut error_out);
        assert!(!ok);
...
fn test_estimated_document_count_null_db_name() {
    ...
    unsafe {
        ...
        let future = mongoc_future_estimated_document_count(
            client,
            ptr::null(),
            ptr::null(), // null db_name
            coll.as_ptr(),
